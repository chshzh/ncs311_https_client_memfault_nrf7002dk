...
#else
static inline int mflt_services_init(void)
{
	return 0;
}

static inline void mflt_services_handle_network_connected(void)
{
}

static inline void mflt_services_handle_network_disconnected(void)
{
}
